...
def remove_background(image: Image):
    """It returns the version of the input image without background"""
...
def downsize(image: Image, width: int = 640, height: int = 360):
    """It returns a downsized version of the input image"""
...
def blur(image: Image):
    """It returns a blurred version of the input image"""
...
def black_white(image: Image):
    """It returns a black and white version of the input image"""
